        ...
        void queueClinic(string clinicPrefix)
        {
                // READ txt file for corresponding clinic
                string fileLocation = "database/clinic_" + clinicPrefix + ".txt";
                ...
                if (filereader.peek() == std::ifstream::traits_type::eof())
                {
                    ...
                    string queueNumber = clinicPrefix + "Q0001";
                ...
                else 
                {
                    ...
                    queueNumber = clinicPrefix + "Q" + stringDigits;
